...
namespace Lab2
{
    class Program
    {
        ...
        [DllImport("Lab1_1_alt1.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int myAdd(int number1, int number2);

        //extern "C" LAB1_1_API char* myAddStr(char* str1, char* str2)
        [DllImport("Lab1_1_alt1.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        public static extern IntPtr myAddStr(string str1, string str2);

        //extern "C" LAB1_1_API string myAddStr(string str1, string str2) <-- PInvoke kender ikkt til string-klassen i C++, så dette fejler!!!
        [DllImport("Lab1_1_alt1.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern IntPtr myAddString(string str1, string str2);

        //extern "C" LAB1_1_API bool DeletePtr(char* ptr);
        [DllImport("Lab1_1_alt1.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern bool DeletePtr(IntPtr ptr);
