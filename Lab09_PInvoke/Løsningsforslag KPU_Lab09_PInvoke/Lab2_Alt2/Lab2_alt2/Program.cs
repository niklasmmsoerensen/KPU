...
namespace Lab2
{
    class Program
    {
        ...
        [DllImport("Lab1_1_alt2.dll", CallingConvention = CallingConvention.Cdecl)]
        public static extern int myAdd(int number1, int number2);

        //extern "C" LAB1_1_API char* myAddStr(char* str1, char* str2)
        [DllImport("Lab1_1_alt2.dll", CallingConvention = CallingConvention.Cdecl, CharSet = CharSet.Ansi)]
        ...
        static void Main(string[] args)
        {
            ...
            Marshal.FreeHGlobal(ptr); // Can free memory allocated by LocalAlloc
