// PizVizClient.cpp : Defines the entry point for the console application.
//

#include "stdafx.h"
#include "COMerrorUtiliti.h"

#import "..\PizVizServer\Debug\PizVizServer.dll" no_namespace named_guids
...
int _tmain(int argc, _TCHAR* argv[])
{
	...
	hr = CoInitialize(NULL);
	{
		...
		IPizzaManagerPtr spPizzaMan (__uuidof(CPizzaManager));
		if(NULL == spPizzaMan)
		{
		...
		IOrderCalculatorPtr spOrderCalc (__uuidof(COrderCalculator));
		if(NULL == spOrderCalc)
		{
